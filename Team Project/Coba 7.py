...
dengan destinasi wisata yang terdiri dari Pantai Pandawa, Pantai Luhur Uluwatu, Pantai Kuta, Tegallalang Rice Terrace, 
Kintamani,  Desa Panglipuran, Tanah Lot, Joger dan mengelilingi exoticnya pulau Bali untuk lebih mengenal suku, budaya, dan alamnnya.""")
                        print(135*"-")
...
dengan destinasi wisata yang terdiri dari Watersport Tanjung Benoa, Nusa Dua , Pulau Penyu,Garuda Wisnu Kencana, Pura Luhur Uluwatu, 
Pantai Pandawa, Tegallalang Rice Terrace, Kintamani,Toya Devasya, Desa Penglipuran,Pura Ulun Danu Beratan,Jatiluwih Rice Terrace, 
Pura Tanah Lot,Bali Zoo,Krisna Oleh Oleh, Joger Kuta, dan mengelilingi exoticnya pulau Bali untuk lebih mengenal suku, budaya, dan alamnya.""")
                        print(135*"-")
                        break
                    elif Kota == 2 :
                        No = 6
                    ...
                    -------------------------------------------------""")
                        ...
                        print("-------------------------------")
                        print("""Kami menyiapkan jadwal standar kegiatan wisata di Lombok menginap 3 hari 2 malam di hotel bintang empat, dengan destinasi wisata yang terdiri dari  Desa Sukarara, Pantai Kuta Mandalika Lombok,  Bukit Merese, Gili Trawangan, Bukit Malaka/ Malimbu, Pusat Oleh-oleh,Pelabuhan Teluk Nare, Monkey Forest, Pura Taman Narmada, dan mengelilingi exoticnya pulau Lombok untuk lebih mengenal suku,budaya, dan alamnya.""")
                        print(140*"-")
                        print("Deskripsi Paket Wisata II Lombok")
                        print("--------------------------------")
                        print("""Kami menyiapkan jadwal standar kegiatan wisata di Lombok menginap 5 hari 4 malam di hotel bintang empat, dengan destinasi wisata yang terdiri dari Desa Sukarara, Pantai Kuta Mandalika Lombok, Pantai Tanjung Aan,  Bukit Merese, i Monkey Forest, Pelabuhan Teluk Nare, Gili Trawangan,  Bukit Malaka/ Malimbu, Desa Senaru, Air Terjun Sendang Gile, Pusat  Oleh – Oleh, Pelabuhan Tanjung Luar, Pantai Pink (pink 1 & pink 2), Gili Petelu, Pura Taman Narmada, dan mengelilingi exoticnya pulau Lombok untuk lebih mengenal suku, budaya, dan alamnya.""")
                        print(140*"-")
                        break
                    elif Kota == 3 :
                        No = 6
...
tiga, dengan destinasi wisata yang terdiri dari Keraton Kasultanan Yogyakarta, Istana Taman Sari, Candi Borobudur, Desa Wisata Bukit
Teletubbies, Taman Lampion Pelangi, Alun-Alun Kota Jogja, Candi Prambanan, Gunung Kidul, Museum Gunung Merapi, Pabrik Batik, Bukit Kali Kuning, dan mengelilingi exoticnya Kota Yogyakarta untuk lebih mengenal suku, budaya, dan alamnya. """)
                        print(145*"-")
                        print("Deskripsi Paket Wisata II Jogjakarta")
                        print("------------------------------------")
                        print("""Kami menyiapkan jadwal standar kegiatan wisata di Yogyakarta menginap 5 hari 3 malam di hotel bintang tiga, dengan destinasi wisata yang terdiri dari Keraton Kasultanan Yogyakarta, Istana Taman Sari,
Candi Borobudur, Desa Wisata Bukit Teletubbies, Taman Lampion Pelangi, Alun-Alun Kota Jogja, Candi Prambanan, Gunung Kidul, Museum Gunung Merapi, Pabrik Batik, Bukit Kali Kuning, dan mengelilingi exoticnya Kota
Yogyakarta untuk lebih mengenal suku, budaya, dan alamnya. """)
                        break
                    elif Kota == 4 :
                        No = 6
                        ...
                        print("----------------------------------------")
                        print("""Kami menyiapkan jadwal standar kegiatan wisata  Jakarta-Bandung menginap 3 hari 2 malam di hotel bintang tiga dengan destinasi 
wisata yang terdiri dari Tangkuban Perahu, Floating Market, Orchid Forest, Kawah Putih, Glamping Lakeside, Kebun Teh Rancabali, Bandung City Tour dan Cibaduyut, dan mengelilingi
exoticnya Kota Jakarta-Bandung untuk lebih mengenal suku, budaya, dan alamnya.""")
                        ...
                        print("-----------------------------------------")
                        print("""Kami menyiapkan jadwal standar kegiatan wisata Jakarta-Bandung menginap 5 hari 4 malam di hotel bintang tiga dengan destinasi wisata yang terdiri 
dari Factory Outlet, Lembang, Tangkuban Perahu, Ciwalk, Primasari, Cibaduyut, Kawah Putih, Monas, Thamrin City, Pantai Indah Kapuk 2 (PIK-2), dan mengelilingi exoticnya Kota Jakarta-Bandung
untuk lebih mengenal suku, budaya, dan alamnya.""")
                        print(145*"-")
                        break
                    elif Kota == 5 :
...
dengan destinasi wisata yang terdiri dari Kampung Adat Bena, Pemandian Air Panas Soa, Kawasan Riung 17, Kalong Hill, Pulau Ontoloe, Pulau Rutong,
Pulau Tiga, Pulau Tembang, Kelimutu, Tempat Pengasingan Bung Karno, Pasar Ende ,dan mengelilingi exoticnya pulau Lombok untuk lebih mengenal suku, budaya, dan alamnya.""")
                        print(145*"-")
                        print("Deskripsi Paket Wisata II Labuan Bajo")
                        print("-------------------------------------")
                        print("""Kami menyiapkan jadwal standar kegiatan wisata di Labuan Bajo menginap 4 hari 3 malam di hotel bintang tiga, dengan destinasi wisata yang terdiri dari
Kampung Adat Ratenggaro, Pantai Bawana, Pantai Mandorak, Danau Weekuri, Kampung Adat Praijing, Sunset Bukit Wairinding, Savana Puru Kambera, Pantai Puru Kambera, Air Terjun Waimarang, Sunset Pantai Walakiri,
Milky Way dan Sunrise Bukit Tenau, Tenun Ikat, Toko Souvenir di Sumba Timur , dan mengelilingi exoticnya pulau Lombok untuk lebih mengenal suku, budaya, dan alamnya.""")
                        break
                    else:
                        break
