...
di Sumba Timur , dan mengelilingi exoticnya pulau Lombok untuk lebih mengenal suku, budaya, dan alamnya.""")
                ...
                if x== "Y" or x == "y":
                    ...
                    while True:
                        try:        
                            tahun = int(input("    Tahun  (1-4 digit)       = "))
                            if tahun > 9999 or tahun <1:
                                raise ValueError
                            break
                        except ValueError:
                                print("   Masukkan input yang valid ") 
                        ...
                        try:
                            ...
                            if (tahun %400 == 0) or (tahun %100 != 0)and (tahun %4 == 0):
                                ...
                                if tanggal >28 and bulan == 2:
                                    raise ValueError
                                if tanggal >30 and bulan == 4 :
                                    raise ValueError      
                                if tanggal >30 and bulan == 6 :
                                    raise ValueError
                                if tanggal >30 and bulan == 9 :
                                    raise ValueError
                                if tanggal >30 and bulan == 11 :
                                    raise ValueError                
                            break
                        except ValueError:
                            print("   Masukkan input yang valid ")
